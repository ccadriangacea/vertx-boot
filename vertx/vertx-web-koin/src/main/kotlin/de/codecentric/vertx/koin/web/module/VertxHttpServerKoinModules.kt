...
open class VertxHttpServerKoinModules : KoinModule {
    ...
    }.toModuleWithOrder(10, moduleName = "vertxHttpServerOrderedKoinModule")

    override val koinOrderedModules: LinkedHashSet<ModuleWithOrder> = linkedSetOf(vertxHttpServerOrderedKoinModule)
}

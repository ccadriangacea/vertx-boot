...
open class CustomPortVertxWebKoinModules : KoinModule {
    ...
    }.toModuleWithOrder(moduleName = "customPortVertxWebOrderedKoinModule")

    override val koinOrderedModules: LinkedHashSet<ModuleWithOrder> = linkedSetOf(customPortVertxWebOrderedKoinModule)
}

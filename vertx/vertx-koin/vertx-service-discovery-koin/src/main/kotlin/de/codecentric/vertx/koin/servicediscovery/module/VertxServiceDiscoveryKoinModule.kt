...
class VertxServiceDiscoveryKoinModule : KoinModule {
    ...
    }.toKoinModuleWithOrder(moduleName = "vertxServiceDiscoveryOrderedKoinModule")

    override val koinOrderedModules: LinkedHashSet<KoinModuleWithOrder> = linkedSetOf(vertxServiceDiscoveryOrderedKoinModule)
}

...
class VertxConfigKoinModule : KoinModule {
    private val vertxConfigKoinOrderedModule: ModuleWithOrder = module {
    ...
    }.toModuleWithOrder(moduleName = "vertxConfigKoinOrderedModule")

    override val koinOrderedModules: LinkedHashSet<ModuleWithOrder> = linkedSetOf(vertxConfigKoinOrderedModule)
}

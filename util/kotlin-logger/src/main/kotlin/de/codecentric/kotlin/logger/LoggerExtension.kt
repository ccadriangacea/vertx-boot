...
import de.codecentric.kotlin.logger.ConsoleColors.BLACK
import de.codecentric.kotlin.logger.ConsoleColors.CYAN_BACKGROUND
import de.codecentric.kotlin.logger.ConsoleColors.GREEN_BACKGROUND
import de.codecentric.kotlin.logger.ConsoleColors.RED_BACKGROUND
import de.codecentric.kotlin.logger.ConsoleColors.TEXT_RESET
import de.codecentric.kotlin.logger.ConsoleColors.YELLOW_BACKGROUND
...
fun KLogger.positiveEvent(deltaTabCount: Int = 0, message: () -> Any?) = this.loggerWithTab("$BLACK $GREEN_BACKGROUND", deltaTabCount, WARNING, message)
fun KLogger.neutralEvent(deltaTabCount: Int = 0, message: () -> Any?) = this.loggerWithTab("$BLACK $YELLOW_BACKGROUND", deltaTabCount, WARNING, message)
fun KLogger.negativeEvent(deltaTabCount: Int = 0, message: () -> Any?) = this.loggerWithTab("$BLACK $RED_BACKGROUND", deltaTabCount, WARNING, message)
fun KLogger.testEvent(deltaTabCount: Int = 0, message: () -> Any?) = this.loggerWithTab("$BLACK $CYAN_BACKGROUND", deltaTabCount, WARNING, message)
